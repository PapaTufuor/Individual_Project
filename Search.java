...
public class Search {
    ...
    public Search(int numberOfNodes){
    ...
    public int uniformCostSearch(int adjacencyMatrix[][], int source, int destination) {
        ...
        for (int sourcevertex = 1; sourcevertex<= numberOfNodes; sourcevertex++)
        {
            ...
            {
                this.adjacencyMatrix[sourcevertex][destinationvortex]= adjacencyMatrix[sourcevertex][destinationvertex];
...
class Node implements Comparator<Node>
{
    ...
    @Override
    public int compare(Node node1, Node node 2)
    {
